(() => {
  ...
  const addPage = (route, spec) => { bundle.pages[route] = mergeSpec(bundle.pages[route], spec); };
  ...
  addPage("/blog/post.html", {
    ...
    text: {
      ...
      "This is something screenshots never show:\nthe cost of perfection.": "Das ist etwas, das Screenshots nie zeigen:\nder Preis der Perfektion.",
  ...
  addPage("/lost-administrator/extras/graphics/", {
    ...
    text: {
      ...
      "03 · Final Image Collage ": "03 · Finale Bildcollage ",
      "[spoiler]": "[Spoiler]",
  ...
  bundle.audit.linuxAcademyInteractiveLabs = {
    ...
    note: "These lab routes use the maintained Linux Academy German prefix plus dynamic mutation translation.",
    routes: [
