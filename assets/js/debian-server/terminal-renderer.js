...
export class TerminalRenderer {
  ...
  line(text,className) { const element=this.history.ownerDocument.createElement('div');element.className=className;element.textContent=text;this.history.append(element); }
