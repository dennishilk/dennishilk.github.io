...
export function defaultWorkstationState() {
  ...
  return { schemaVersion:WORKSTATION_SCHEMA_VERSION, currentDirectory:home, filesystem:createWorkstationFilesystem(), commandHistory:[], sessionStartedAt:started,
    ...
    aliases:{ll:'ls -alF',la:'ls -A',l:'ls -CF'}, mail:{read:{},currentFolder:'INBOX'}, processes:createProcesses(), services:createServices(), packages:createPackages(), journal:[], machine:{power:'running'}, system:{kernel:'6.12.38+deb13-amd64',frozenLocal:'Fri Jul 31 15:18:43 EDT 2026',frozenUtc:'Fri Jul 31 19:18:43 UTC 2026',login:{user:'m.weber',tty:'tty1',local:'Jul 31 13:41',utc:'Fri Jul 31 17:41:26 UTC 2026'}} , lastExitCode:0 };
}
