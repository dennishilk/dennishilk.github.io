...
assert.equal(view.getLifecycle(), Lifecycle.RUNNING); assert.deepEqual(view.getCounts(), { launchCount: 1, gameInitCount: 1, rafStartCount: 1, rafScheduledCount: 1, rafCallbackCount: 0, resizeCount: 1, renderCount: 0, renderFrameCount: 0, canvasWidth: 800, canvasHeight: 500, contextAvailable: true, turretDrawCalls: 0 });
