  ...
  const patchCiscoFieldNote7 = () => {
    ...
    const patchNobelschroeder = () => {
      ...
      if (germanParagraphs?.[1]) {
        germanParagraphs[1].innerHTML = 'In der Szene steigt <strong>Nobelschröder</strong> auf einem gefrorenen See aus dem Auto und rutscht sofort hin und her. Werner sagt: <strong>„Sag mal, kannst du nicht vernünftig grüßen?!“</strong> Und Andi: <strong>„Anständigen Diener!“</strong>';
      }
      ...
      if (englishParagraphs?.[1]) {
        englishParagraphs[1].innerHTML = 'In the scene, <strong>Nobelschröder</strong> gets out of a car onto a frozen lake and immediately starts sliding around. Werner says: <strong>“Hey, can’t you greet properly?!”</strong> And Andi adds: <strong>“A proper bow!”</strong>';
      }
